...
export default function DeliveriesPage() {
    ...
    const handleValidate = async (id: string) => {
        if (confirm('Validate this delivery? Stock will be decreased.')) {
            try {
    ...
    const handleDelete = async (id: string) => {
        if (confirm('Delete this draft delivery?')) {
            try {
            ...
            <DashboardLayout>
                <div className="space-y-6">
                    <div className="flex justify-between items-center">
                        <div>
                            <h1 className="text-3xl font-bold text-gray-900">Deliveries (Outgoing Stock)</h1>
                            <p className="text-gray-600 mt-2">Manage outgoing inventory</p>
                        </div>
                        <button
                            onClick={openModal}
                                    ...
                                    {deliveries.map((delivery) => (
                                        <tr key={delivery.id}>
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                                {getWarehouseName(delivery.warehouseId)}
                                            </td>
                                            <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">
                                            ...
                                            <td className="px-6 py-4 whitespace-nowrap">
                                                <span
                                                    className={`px-2 py-1 text-xs font-medium rounded-full ${delivery.status === 'VALIDATED'
                        ...
                        <div className="flex items-center justify-center min-h-screen px-4">
                            ...
                            <div className="relative bg-white rounded-lg max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
                                <div className="flex justify-between items-center mb-4">
                                    <h3 className="text-lg font-semibold text-gray-900">Create Delivery</h3>
